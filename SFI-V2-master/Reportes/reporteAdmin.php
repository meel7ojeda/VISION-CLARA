...
<head>
    ...
    <title>Reporte de Administradores Activos</title>
...
<body>
    <div class="reporte">
        <h3>Reporte de Administradores Activos</h3>
        ...
        <div>
           <div>
            <a href="pdf_admin_activos.php" class="mdl-button mdl-js-button mdl-button--raised mdl-button--colored">
    DESCARGAR PDF</a>
        </div>
        ...
        <br>
        <div>
            <a href="excel_admin.php" class="mdl-button mdl-js-button mdl-button--raised mdl-button--colored">
    DESCARGAR EXCEL
</a>
        </div>
        <?php endif; ?>
